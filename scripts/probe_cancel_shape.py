...
def parse_args():
    parser = argparse.ArgumentParser(description='Probe cancel response shape without mutating storage.')
...
def main():
    ...
    response = polymarket_client.cancel_order(order_id=args.order_id, client_order_id=args.client_order_id, dry_run=(not args.live))
